/* Lentton — thin-stroke icon set. All inherit currentColor. */
(function () {
  const S = (paths, props = {}) => (
  ...
  const Icon = {
    ...
    prev: () => S(<><path d="M11 6 5 12l6 6" /><path d="M19 6l-6 6 6 6" /></>),
    next: () => S(<><path d="M13 6l6 6-6 6" /><path d="M5 6l6 6-6 6" /></>),
    settings: () => S(<>
    ...
    moon: () => S(<path d="M20 13.5A8 8 0 0 1 9.5 4a7 7 0 1 0 10.5 9.5Z" />),
    plus: () => S(<path d="M12 5v14M5 12h14" />),
    search: () => S(<><circle cx="11" cy="11" r="6.2" /><path d="m20 20-3.6-3.6" /></>),
    volume: () => S(<>
